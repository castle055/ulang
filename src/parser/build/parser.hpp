...
switch (yykind)
    ...
    parser (void* scanner_yyarg, yy::location& loc_yyarg, parser_ctx_t& ctx_yyarg);
    virtual ~parser ();
    ...
    // Implementation of make_symbol for each token kind.
      ...
      static
      symbol_type
      make_ROOT (location_type l)
      {
        return symbol_type (token::ROOT, std::move (l));
      }
#else
      static
      symbol_type
      ...
      static
      symbol_type
      make_LEFT_BRC (location_type l)
      {
        return symbol_type (token::LEFT_BRC, std::move (l));
      }
#else
      static
      symbol_type
      make_LEFT_BRC (const location_type& l)
      {
        return symbol_type (token::LEFT_BRC, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_RIGHT_BRC (location_type l)
      {
        return symbol_type (token::RIGHT_BRC, std::move (l));
      }
#else
      static
      symbol_type
      make_RIGHT_BRC (const location_type& l)
      {
        return symbol_type (token::RIGHT_BRC, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_TOKENS_KW (const location_type& l)
      {
        return symbol_type (token::TOKENS_KW, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_RULES_KW (location_type l)
      {
        return symbol_type (token::RULES_KW, std::move (l));
      }
#else
      static
      symbol_type
      make_RULES_KW (const location_type& l)
      {
        return symbol_type (token::RULES_KW, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_TOKEN_REGEX (std::string v, location_type l)
      {
      ...
      static
      symbol_type
      make_TOKEN_REGEX (const std::string& v, const location_type& l)
      {
      ...
      static
      symbol_type
      make_GRAMMAR_SPEC_TAG (std::string v, location_type l)
      {
        return symbol_type (token::GRAMMAR_SPEC_TAG, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_GRAMMAR_SPEC_TAG (const std::string& v, const location_type& l)
      {
        return symbol_type (token::GRAMMAR_SPEC_TAG, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_GRAMMAR_TAG (std::string v, location_type l)
      {
        return symbol_type (token::GRAMMAR_TAG, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_GRAMMAR_TAG (const std::string& v, const location_type& l)
      {
        return symbol_type (token::GRAMMAR_TAG, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_RAW_TOKEN (std::string v, location_type l)
      {
        return symbol_type (token::RAW_TOKEN, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_RAW_TOKEN (const std::string& v, const location_type& l)
      {
        return symbol_type (token::RAW_TOKEN, v, l);
      }
#endif
